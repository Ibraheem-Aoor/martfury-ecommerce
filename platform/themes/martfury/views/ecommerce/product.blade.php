...
<div class="ps-page--product">
    <div class="ps-container">
                        ...
                        <div class="ps-product__info">
                            ...
                            @if ($flashSale)
                                <div class="ps-product__countdown">
                                    <figure>
                                        <figcaption> {{ __("Don't Miss Out! This promotion will expires in") }}
                                        </figcaption>
                                    ...
                                    <figure>
                                        ...
                                        <div class="ps-product__progress-bar ps-progress"
                                            ...
                                            <p><b>{{ $flashSale->pivot->sold }}/{{ $flashSale->pivot->quantity }}</b>
                                                {{ __('Sold') }}</p>
                                        </div>
                                    </figure>
                                </div>
                                ...
                                <div class="ps-product__shopping">
                                    <figure>
                                        ...
                                        <div class="form-group--number product__qty">
                                            ...
                                            <input class="form-control qty-input" type="text" name="qty"
                                                value="1" placeholder="1" readonly>
                                        </div>
                                    </figure>
                                    ...
                                    @if (EcommerceHelper::isCartEnabled())
                                        ...
                                        @if (EcommerceHelper::isQuickBuyButtonEnabled())
                                            <button
                                                class="ps-btn @if ($product->isOutOfStock()) btn-disabled @endif"
                                ...
                                <div class="ps-tab" id="tab-reviews">
                                        ...
                                        <div class="col-lg-5">
                                            <div class="ps-block--average-rating">
                                                ...
                                                @foreach (EcommerceHelper::getReviewsGroupedByProductId($product->id, $product->reviews_count) as $item)
                                                    <div class="ps-block__star @if (!$item['count']) disabled @endif"
                                                        data-star="{{ $item['star'] }}">
                                    ...
                                    @if ($product->reviews_count)
                                        @if (count($product->review_images))
                                            <div class="my-3">
                                                <h4>{{ __('Images from customer') . ' (' . count($product->review_images) . ')' }}
                                                </h4>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="block--product-reviews">
                                                    <div
                                                        class="block__header d-md-flex align-items-center justify-content-between">
                                                        ...
                                                        <div
                                                            class="ps-review__filter-by-star d-flex align-items-center justify-content-end">
        ...
        <div class="ps-section--default" id="products">
            ...
            <related-products-component url="{{ route('public.ajax.related-products', $product->id) }}?limit=6">
