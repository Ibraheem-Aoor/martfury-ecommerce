            ...
            <div class="ps-form__content">
                ...
                <div class="form-group">
                    <input class="form-control" type="password" name="password_confirmation"
                        id="txt-password-confirmation" autocomplete="new-password" placeholder="{{ __('Password') }}">
                ...
                @if (is_plugin_active('marketplace'))
                    <div class="show-if-vendor" @if (old('is_vendor') == 0) style="display: none" @endif>
                        ...
                        <div class="form-group">
                            <label for="commerce_number" class="required">{{ __('Chamber of Commerce No') }}</label>
                            <input class="form-control" name="commerce_number" id="commerce_number" type="text"
                                value="{{ old('commerce_number') }}" placeholder="{{ __('Chamber of Commerce No') }}">
                            @if ($errors->has('commerce_number'))
                                <span class="text-danger">{{ $errors->first('commerce_number') }}</span>
                            @endif
                        </div>
                        <div class="form-group">
                            <label for="tax_number" class="required">{{ __('Tax Number') }}</label>
                            <input class="form-control" name="tax_number" id="tax_number" type="text"
                                value="{{ old('tax_number') }}" placeholder="{{ __('Tax Number') }}">
