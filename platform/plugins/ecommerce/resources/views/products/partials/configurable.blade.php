<div id="product-variations-wrapper">
    <div class="variation-actions">
        <a href="#" class="btn-trigger-delete-selected-variations text-danger" style="display: none"
            data-target="{{ route('products.delete-versions') }}">{{ trans('plugins/ecommerce::products.delete_selected_variations') }}</a>
    ...
    @if (!$productVariations->isEmpty())
        <table class="table table-hover-variants">
            <thead>
                <tr>
                    <th><input class="table-check-all" data-set=".table-hover-variants .checkboxes" type="checkbox">
                    </th>
            ...
            <tbody>
                @foreach ($productVariations as $variation)
                    ...
                    <tr id="variation-id-{{ $variation->id }}">
                        <td style="width: 20px;"><input type="checkbox" class="checkboxes m-0" name="id[]"
                                value="{{ $variation->id }}"></td>
                        <td>
...
{!! Form::modalAction(
    'delete-variations-modal',
    trans('plugins/ecommerce::products.delete_variations'),
    'danger',
