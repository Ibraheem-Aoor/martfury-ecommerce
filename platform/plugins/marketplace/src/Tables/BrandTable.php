...
class BrandTable extends TableAbstract
{
    ...
    public function ajax()
    {
        $data = $this->table
            ...
            ->editColumn('name', function ($item) {
                return Html::link(route('marketplace.vendor.brands.edit', $item->id), clean($item->name));
            })
            ...
            ->addColumn('operations', function ($item) {
                return $this->getOperations('marketplace.vendor.brands.edit', 'marketplace.vendor.brands.destroy', $item);
            });
    ...
    {
        return $this->addCreateButton(route('marketplace.vendor.brands.create'), null);
    }
