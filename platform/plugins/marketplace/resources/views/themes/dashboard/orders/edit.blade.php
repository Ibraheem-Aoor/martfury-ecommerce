                                        ...
                                        <tr>
                                            ...
                                            <td class="pl5 p-r5 min-width-200-px">
                                                <a class="text-underline hover-underline pre-line" target="_blank"
                                                    href="{{ $product ? route('marketplace.vendor.products.edit', $product->original_product->id) : '#' }}"
                                                            ...
                                                            <table>
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td><a href="{{ route('marketplace.vendor.orders.edit', $order->id) }}"
            ...
            <div class="ui-layout__item">
                                    ...
                                    <a href="#" class="btn-trigger-update-shipping-address">
                                        <span data-placement="top" data-bs-toggle="tooltip"
                                            ...
                                            <svg class="svg-next-icon svg-next-icon-size-12">
                                                <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#next-edit">
                                                </use>
                                            </svg>
                                        </span>
                                    </a>
                ...
                <div id="extra-shipment-info" class="widget meta-boxes">
                    ...
                    <div class="widget-body">
                        <form id="shipping_info" action="{{ route('marketplace.vendor.orders.company_info.update') }}">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="shipping_company_name" id="shipping_company_name"
                                    class="form-control" placeholder="Ex: DHL, AliExpress..."
                                    value="{{ $order->shipping_company_name }}">
                            </div>
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="tracking_id" id="tracking_id" class="form-control"
                                    value="{{ $order->shipping_tracking_id }}" placeholder="Ex: JJD0099999999">
                            </div>
                            <div class="form-group mb-3">
                                <label for="tracking_link" class="control-label">Tracking Link</label>
                                <input type="text" name="tracking_link" id="tracking_link"
                                    value="{{ $order->shipping_tracking_link }}" class="form-control"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="estimate_date_shipped" id="estimate_date_shipped"
                                    ...
                                    value="{{ $order->estimate_arrival_date }}" placeholder="yyyy/mm/dd">
                            </div>
                            <div class="form-group mb-3">
