            ...
            <div class="table-responsive">
                <table class="table text-start table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>Lettuce - Baby Salad Greens</td>
                            <td>Cras mi pede, malesuada in, imperdiet et, commodo vulputate, justo. In blandit ultrices
                                enim.</td>
                            <td></td>
                            <td>2,3</td>
                            <td>published</td>
                        ...
                        <tr>
                            ...
                            <td>In sagittis dui vel nisl. Duis ac nibh. Fusce lacus purus, aliquet at, feugiat non, pretium
                                quis, lectus.</td>
                            <td></td>
                            <td>4,5</td>
                            <td>pending</td>
            ...
            <table class="table text-start table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>(required|enum:{{ implode(',', Botble\Base\Enums\BaseStatusEnum::values()) }}|default:{{ Botble\Base\Enums\BaseStatusEnum::PENDING }})
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>(nullable|enum:{{ implode(',', Botble\Ecommerce\Enums\StockStatusEnum::values()) }}|default:{{ Botble\Ecommerce\Enums\StockStatusEnum::IN_STOCK }})
                        </td>
                    </tr>
                    <tr>
